...
impl PaletteAction {
    ...
    pub fn label(&self) -> &'static str {
        match self {
            ...
            Self::OpenCollectionRunner => "Collection Runner…",
            Self::OpenSync => "Workspace Sync…",
            Self::ImportCollection => "Import collection file…",
            Self::CreateBackup => "Create workspace backup",
            Self::OpenBackups => "Backups…",
    ...
    pub fn keywords(&self) -> &'static str {
        match self {
            ...
            Self::OpenCollectionRunner => "runner collection run batch data rows csv json report",
            Self::OpenSync => "sync git workspace openapi refresh import export",
            Self::ImportCollection => "import postman json yaml",
            Self::CreateBackup => "snapshot restore data safety",
            Self::OpenBackups => "restore snapshot data safety location",
